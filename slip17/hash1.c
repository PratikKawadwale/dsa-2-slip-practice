//Q2. Write a menu driven program to implement hash table using array (insert, search, display). Use any of the above-mentioned hash functions. In case of collision apply linear probing.
#include<stdio.h>
#include<stdlib.h>
struct node
{
